...
//         formDataUpload.append('articlePMID', recordId);
//         formDataUpload.append('drugName', drugName);

//        try {
//   const documentUrl = await DatabaseService.uploadDocumentToBackend(formDataUpload.get('file'), formDataUpload.get('articlePMID'));
...
//     // Check for exact PMID match first if searchTerm looks like a full PMID
//     if (/^\d{8}$/.test(searchTerm)) { // Assuming PMIDs are 8 digits
//       return pmid === searchLower;
//     }

//     // Fallback to substring search across all fields
